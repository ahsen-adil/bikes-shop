...
import img1 from "../../../sale1.webp"
import img2 from "../../../sale2.webp"
import img3 from "../../../sale3.webp"
import img4 from "../../../sale4.webp"
import img5 from "../../../sale5.webp"
import img6 from "../../../sale6.webp"
import img7 from "../../../sale7.webp"
import img8 from "../../../sale8.webp"

export default function Bestsale() {
    return (
      <>
       <section className="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12 mt-[70px]">
  <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
    ...
    <div className="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
      ...
      <div data-aos="flip-up" data-aos-duration="3000" className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div className="h-56 w-full">
          <a href="#">
                        <Image src={img6} alt="img" className="h-full"/>
      ...
      <div data-aos="flip-up" data-aos-duration="3000" className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div className="h-56 w-full">
          <a href="#">
                        <Image src={img7} alt="img" className="h-full"/>
      ...
      <div data-aos="flip-up" data-aos-duration="3000" className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div className="h-56 w-full">
          <a href="#">
                        <Image src={img8} alt="img" className="h-full"/>
